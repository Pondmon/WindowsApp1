...
Public Class Form10
    ...
    Public Sub Nomal()
        ...
        Text_SEM.BorderStyle = BorderStyle.Fixed3D
    ...
    Public Sub Update_SQL()
        ...
        Try
            ...
            Query_CMD = "UPDATE `Project_std` SET `ID1`='" & Text_ID1.Text & "',`ID2`='" & Text_ID2.Text & "',`ID3`='" & Text_ID3.Text & "',`NAME1`='" & Text_Name1.Text & "',`NAME2`='" & Text_Name2.Text & "',`NAME3`='" & Text_Name3.Text & "',`PHONE1`='" & Text_P1.Text & "',`PHONE2`='" & Text_P2.Text & "',`PHONE3`='" & Text_P3.Text & "',`PROJECTNAME`='" & Text_NAMEP.Text & "',`PROJECTADVISOR`='" & ComboBox4.Text & "',`SEMESTER`='" & Text_SEM.Text & "',`YEARS`='" & Text_Year.Text & "' WHERE `Barcode`='" & old_barcode_id.ToString & "'"
